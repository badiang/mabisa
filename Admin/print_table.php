	...
	<div class="table-responsive">
		...
		<table class="table">
			<?php 
		      ...
		      $stmt = $dbconn->prepare("SELECT COUNT(*) FROM assessment where region_code=? and province_code=? and city_code=? and year=?");
		      $stmt->bindParam(1, $region);
		      $stmt->bindParam(2, $province);
		      $stmt->bindParam(3, $city);
		      $stmt->bindParam(4, $assessment_year);
		      $stmt->execute();
