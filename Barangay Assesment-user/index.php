                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-lg-12 mr-2 text-center">
                                            <div class="h5 mb-0 font-weight-bold text-white">1 / 7</div>
                                        </div>
                                        <!-- <div class="col-auto">
                            ...
                            <div class="card shadow h-100 py-2" style="background-color: #F1C40F;">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-lg-12 mr-2 text-center">
                                            <div class="h5 mb-0 font-weight-bold text-white">2 / 3</div>
                                        </div>
                                        <!-- <div class="col-auto">
                                            <i class="fas fa-calendar fa-2x text-gray-300"></i>
                                        </div> -->
                            ...
                            <div class="card bg-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-lg-12 mr-2 text-center">
                                            <div class="h5 mb-0 font-weight-bold text-white">3 / 6</div>
                                        </div>
                                        <!-- <div class="col-auto">
                                            <i class="fas fa-calendar fa-2x text-gray-300"></i>
                                        </div> -->
                            ...
                            <div class="card bg-danger shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-lg-12 mr-2 text-center">
                                            <div class="h5 mb-0 font-weight-bold text-white">4 / 7</div>
                                        </div>
                                        <!-- <div class="col-auto">
                                            <i class="fas fa-calendar fa-2x text-gray-300"></i>
                                        </div> -->
