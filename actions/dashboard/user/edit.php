...
?>
      ...
      <div class="modal-body">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    <label for="ecity">Municipality Name</label>
        ...
        <div class="row">
            <div class="col-lg-2">
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="eusername" id="eusername" value="<?php echo $result['username'] ?>">
                </div>
            </div>
            <div class="col-lg-2">
                <div class="form-group">
                    <label for="epassword">Password</label>
                    <input class="form-control" type="password" name="epassword" id="epassword" value="<?php echo $result['password'] ?>">
                </div>
            </div>
            <div class="col-lg-2">
                <div class="form-group">
            ...
            <div class="col-lg-2">
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="ephone" id="ephone" value="<?php echo $result['mobile'] ?>" placeholder="ex. +639123456789" maxlength="13">
                </div>
            </div>
            <div class="col-lg-4">
                <div class="form-group">
